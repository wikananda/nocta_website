...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class='scroll-smooth'>
    ...
    <body class='bg-whiteblue bg-cover' style="background-image: url('{{ asset('img/pattern.png') }}');">
        <header class='flex items-center justify-between px-16 2xl:px-64 xl:px-56 lg:px-40 md:px-32 py-5 border-greenblue border-b bg-whiteblue'>
            <a href='/'>
                <img
            ...
            <div class='w-screen/3'>
                ...
                <form class='mt-14' action="" id='feedback-form'>
                    <div>
                        ...
                        <select class='bg-whiteblue w-full focus:ring-lightred  text-2xl mt-3 border border-greenblue' name='game' id='game'>
                    ...
                    <div class='mt-8'>
                        ...
                        <select class='bg-whiteblue focus:ring-lightred  w-full text-2xl mt-3 border border-greenblue' name='type' id='type'>
                    ...
                    <div class='mt-8'>
                        ...
                        <input class='bg-whiteblue w-full focus:ring-lightred text-2xl mt-3 border border-greenblue focus:transition-opacity' type="text" id='title'>
                    </div>
                    <div class='mt-8'>
                        <label class='block font-medium text-2xl text-darkblue' for="feedback">your feedback</label>
                        <textarea class='bg-whiteblue w-full focus:ring-lightred  text-2xl mt-3 border border-greenblue' name="feedback" id="feedback" cols="70" rows="15"></textarea>
                    </div>
