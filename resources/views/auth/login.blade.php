            ...
            <div class='w-full md:w-full lg:w-1/2'>
                ...
                <form class='mt-16' method="POST" action="{{ route('login') }}" id='login-form'>
                    ...
                    <div class="flex items-center justify-start mt-4 flex-row space-x-5">
                        ...
                        <a class="underline text-sm text-darkblue dark:text-darkblue hover:text-darkred dark:hover:text-darkred rounded-md focus:outline-none transition-all" href="{{ route('register') }}">
