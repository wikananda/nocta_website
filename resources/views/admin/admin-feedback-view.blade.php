...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class='scroll-smooth'>
    ...
    <body class='bg-whiteblue h-screen bg-cover relative' style="background-image: url('{{ asset('img/pattern.png') }}');">
        ...
        <div class='min-h-screen px-16 2xl:px-64 xl:px-56 lg:px-40 md:px-32 flex flex-col mb-32'>
            <button type="button" onclick="window.history.back();" class="max-w-xs w-16 mt-14 text-xl flex items-center justify-start text-darkred transition-all font-medium duration-200 bg-transparent gap-x-2 border-transparent border-b-2 hover:text-lightred hover:border-lightred focus:outline-none focus:outline-4">
            ...
            <div class='flex flex-row justify-between max-w-5xl mt-14'>
                <button type='submit' form='reply-form' class='px-7 py-3 text-xl font-semibold text-whiteblue border-transparent border-2 bg-greenblue hover:bg-whiteblue hover:border-greenblue hover:text-greenblue focus:outline-none focus:outline-8 transition-all'>
                    reply
                </button>
                <button type='button' onclick="window.history.back();" class='px-7 py-3 text-xl font-semibold text-darkblue border-transparent border-2 bg-lightred hover:bg-whiteblue hover:border-lightred hover:text-lightred focus:outline-none focus:outline-8 transition-all'>
                    close
                </button>
            </div>
        </div>
