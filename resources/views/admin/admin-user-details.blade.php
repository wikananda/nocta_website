        ...
        <div class='mb-24 mt-36 px-16 2xl:px-64 xl:px-56 lg:px-40 md:px-32 flex flex-row justify-between'>
            <div class='w-full flex flex-row justify-between'>
                ...
                <div class='w-2/3'>
                    ...
                    <form id='edit-form' action="{{ route('admin.update-user', $user->id) }}" class='mt-10' method='POST'>
                        @csrf
                        @method('PATCH')
                        <div>
                        ...
                        <a id="change-password-button" class="block cursor-pointer w-1/5 mt-2 px-4 py-2 text-darkred bg-blue-500 rounded hover:bg-lightred hover:text-darkblue transition-all">Change User Password</a>

                        <div id="password-fields" class="hidden mt-8">
                            <!-- New Password -->
                            <div class="mt-8">
                        ...
                        <div class='flex flex-row justify-between'>
                            ...
                            <button type="submit" form='delete-user' class="mt-10 max-w-xs w-40 px-7 py-4 text-xl font-semibold text-darkblue border-transparent border-2 bg-lightred hover:bg-transparent hover:border-lightred hover:text-lightred transition-all">
                                {{ __('Delete User') }}
                            </button>
                        </div>
                    </div>
